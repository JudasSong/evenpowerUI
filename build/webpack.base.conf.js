    ...
    [require('markdown-it-container'), 'code', {
      ...
      render: function(tokens, idx) {
        ...
        if (tokens[idx].nesting === 1) {
          ...
          // 起始标签,写入code-block模板开头,并传入参数
          return `<code-block class="code-box" :jsfiddle="${jsfiddle}">
