<template>
  <div class="ep-popDialog" style="">
    ...
    <el-table :data="popData" border style="width: 100%">
...
export default {
  ...
  created() {
    // this.popData = [this.initData];
    // console.log("=====", this.initData);
  },
  computed: {},
  methods: {
    getCurrentData() {
      const { approved, freezed } = this.formData
      return { approved, freezed, name: "多层弹框返回数据！" };
    }
  },
  watch: {
    initData: {
